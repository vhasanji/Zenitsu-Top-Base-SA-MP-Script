...
{
    if(!CanPlayerUseAnims(playerid)) return SCM(playerid, COLOR_ERROR, "[ERROR]{ffffff} You're currently unable to use animations at this moment.");
...
CMD:crack(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /crack [1-4]");
	}
    return 1;
}
...
CMD:rap(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /rap [1-3]");
	}
	return 1;
}
...
CMD:wank(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /wank [1-3]");
	}
	return 1;
}
...
CMD:chat(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /chat [1-9]");
	}
	return 1;
}
...
CMD:sitonchair(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /sitonchair [1-7]");
	}
	return 1;
}
...
CMD:bat(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /bat [1-3]");
	}
	return 1;
}
...
CMD:lean(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /lean [1-2]");
	}
	return 1;
}
...
CMD:gesture(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /gesture [1-15]");
	}
	return 1;
}
...
CMD:lay(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /lay [1-3]");
	}
	return 1;
}
...
CMD:wave(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /wave [1-3]");
	}
	return 1;
}
...
CMD:signal(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /signal [1-2]");
	}
	return 1;
}
...
CMD:nobreath(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /nobreath [1-3]");
	}
	return 1;
}
...
CMD:fallover(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /fallover [1-5]");
	}
	return 1;
}
...
CMD:pedmove(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /pedmove [1-26]");
	}
	return 1;
}
...
CMD:getjiggy(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /getjiggy [1-10]");
	}
	return 1;
}
...
CMD:stripclub(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /stripclub [1-2]");
	}
	return 1;
}
...
CMD:smoke(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /smoke [1-2]");
	}
	return 1;
}
...
CMD:dj(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /dj [1-4]");
	}
	return 1;
}
...
CMD:reload(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /reload [1-4]");
	}
	return 1;
}
...
CMD:tag(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /tag [1-2]");
	}
	return 1;
}
...
CMD:deal(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /deal [1-2]");
	}
	return 1;
}
...
CMD:crossarms(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /crossarms [1-5]");
	}
	return 1;
}
...
CMD:cheer(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /cheer [1-8]");
	}
	return 1;
}
...
CMD:sit(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /sit [1-5]");
	}
	return 1;
}
...
CMD:siteat(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /siteat [1-2]");
	}
	return 1;
}
...
CMD:bar(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /bar [1-5]");
	}
	return 1;
}
...
CMD:dance(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /dance [1-14]");
	}
...
CMD:spank(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /spank [1-4]");
	}
	return 1;
}
...
CMD:sexy(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /sexy [1-6]");
	}
	return 1;
}
...
CMD:holdup(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /holdup [1-2]");
	}
	return 1;
}
...
CMD:copa(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /copa [1-9]");
	}
	return 1;
}
...
CMD:misc(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /misc [1-2]");
	}
	return 1;
}
...
CMD:snatch(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /snatch [1-2]");
	}
	return 1;
}
...
CMD:blowjob(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /blowjob [1-2]");
	}
	return 1;
}
...
CMD:kiss(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /kiss [1-6]");
	}
	return 1;
}
...
CMD:idles(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /idles [1-15]");
	}
	return 1;
}
...
CMD:sunbathe(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /sunbathe [1-18]");
	}
	return 1;
}
...
{
    if(!CanPlayerVehAnims(playerid)) return SCM(playerid, COLOR_ERROR, "[ERROR]{ffffff} This animation requires you to be inside a vehicle.");
	if(IsCLowrider(GetPlayerVehicleID(playerid)))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /lowrider [1-31]");
		}
	}
	else
	{
...
CMD:carchat(playerid, params[])
{
	...
	default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /carchat [1-19]");
	}
	return 1;
}
...
CMD:point(playerid, params[])
{
	...
	{
	    return SCM(playerid, COLOR_ERROR, "[ERROR]{ffffff} You're currently unable to use animations at this moment.");
	}
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /point [1-2]");
	}
...
CMD:tired(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /tired [1-2]");
	}
...
CMD:injured(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /injured [1-2]");
	}
...
CMD:aim(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /aim [1-2]");
	}
...
CMD:traffic(playerid, params[])
{
	...
	switch(strval(params))
	{
        ...
        case 2: ApplyAnimationEx(playerid, "POLICE", "CopTraf_Come", 4.1, 0, 0, 0, 0, 0);
	    default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /traffic [1-2]");
	}
...
CMD:ghands(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /ghands [1-10]");
	}
...
CMD:walk(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /walk [1-15]");
	}
...
CMD:fuckme(playerid, params[])
{
	...
	switch(strval(params))
	{
        ...
        default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /fuckme [1-8]");
	}
...
CMD:bj(playerid, params[])
{
	...
	switch(strval(params))
	{
        ...
        default: SCM(playerid, COLOR_GREEN, "[USAGE]{ffffff} /bj [1-12]");
	}
